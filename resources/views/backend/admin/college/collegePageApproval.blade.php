...
@section('title', 'Admin Dashboard || Review College Page')
...
<div class="row" style="height:100vh; overflow:hidden;">
    ...
    <div class="col d-flex flex-column" style="height:100vh; overflow:hidden;">
        ...
        <div class="p-3 border-bottom bg-white" style="flex-shrink:0;">
            <h2 class="h4 mb-0">Review College Page</h2>
        </div>
                ...
                <div class="p-3">
                    <div class="card" id="pageCard" data-page-id="{{ $page->id }}">
                        <div class="card-body">
                            ...
                            @if($page->banner_url)
                            <img src="{{ $page->banner_url }}" class="w-100 mb-3 rounded"
                            ...
                            <div class="d-flex align-items-center mt-3">
                                <div class="col-md-10">
                                        ...
                                        <p class="mb-0">{{ $page->principle_message }}</p>
                                </div>
                                <div class="col-md-2">
                                    @if($page->principle_image_url)
                                    <img src="{{ $page->principle_image_url }}" width="70" height="70"
        ...
        @else
        <div class="p-3">
            <p class="text-muted">No college page has been submitted yet.</p>
        </div>
        @endif
    </div>
</div>
